    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in duration-200">
      ...
      <div className="bg-gradient-to-br from-[#0c1424] via-[#080d19] to-[#040710] border border-amber-500/25 rounded-3xl p-5 sm:p-7 text-slate-100 shadow-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative overflow-hidden">
        <div className="space-y-1.5 relative z-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-500/35 text-[11px] font-bold text-amber-300 shadow-xs">
            ...
            <span>Tier &amp; Subscription Engine</span>
          </div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight text-white">
            Subscriptions &amp; Validity Plans
          </h1>
          <p className="text-xs sm:text-sm text-slate-400">
            Monitor plan tiers, renewal cycles, and active Vadhyar subscription states
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-slate-400">Tracked records</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-emerald-400">Active validity</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-slate-400">365-day commitments</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-slate-400">30-day recurring</div>
        </div>
      </div>
      ...
      <div className="relative max-w-md">
        ...
        <input
          type="text"
          placeholder="Filter by business, plan, or priest name..."
          value={search}
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-extrabold text-sm text-white">{biz?.name || "Independent"}</h4>
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px] bg-[#060a14] p-2.5 rounded-xl border border-slate-800/80">
                <div>
                  <span className="text-[9.5px] text-slate-400 block uppercase">Plan &amp; Cycle</span>
                  <span className="font-bold text-amber-300">{sub.planName} ({sub.billingCycle})</span>
                </div>
                <div>
                  <span className="text-[9.5px] text-slate-400 block uppercase">Valid Until</span>
              ...
              {filtered.map((sub) => {
                ...
                return (
                  <tr key={sub.id} className="hover:bg-slate-800/30 transition">
                    <td className="p-4">
                      <div className="font-extrabold text-white text-sm">{biz?.name || "Independent"}</div>
