    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-slate-400">Outbound Invites</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-amber-400/90">Pending First Payment</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-emerald-500">Rewards Unlocked</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0c1424] via-[#090e1a] to-[#050811] p-4 rounded-2xl border border-slate-800/90 shadow-xl space-y-1">
          ...
          <div className="text-[10.5px] text-slate-400">+30 Days to Each Party</div>
        </div>
      </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-[10px] text-slate-400 block uppercase">Referrer → Referee</span>
                ...
                return (
                  <tr key={r.id} className="hover:bg-slate-800/30 transition">
                    ...
                    <td className="p-4">
                      ...
                      <div className="text-[10px] text-slate-400">Priest / Client</div>
                    </td>
                    ...
                    <td className="p-4 font-bold">
                      {isPaid ? (
                        <span className="text-emerald-400 font-extrabold">+30 Days Awarded to Both</span>
                      ) : (
