...
export const DICTIONARY: Dictionary = {
  ...
  todaysBookings: { en: "Today's Bookings", ta: "இன்றைய முன்பதிவுகள்" },
  ...
  newCustomer: { en: "New Customer", ta: "புதிய வாடிக்கையாளர்" },
  addPooja: { en: "Add Pooja / Homam", ta: "பூஜை சேர்க்க" },
  editPooja: { en: "Edit Pooja", ta: "பூஜை திருத்து" },
  deletePooja: { en: "Delete Pooja", ta: "பூஜை நீக்கு" },
  home: { en: "Home", ta: "முகப்பு" },
  calendar: { en: "Calendar", ta: "நாட்காட்டி" },
  bookings: { en: "Bookings", ta: "முன்பதிவுகள்" },
  pooja: { en: "Pooja & Items", ta: "பூஜை & பொருட்கள்" },
  poojaNav: { en: "Poojas", ta: "பூஜைகள்" },
  ...
  balance: { en: "Balance", ta: "மீதித் தொகை" },
  ...
  saveAsImage: { en: "Save as Image", ta: "படமாகச் சேமி" },
  ...
  adminPanel: { en: "Super Admin", ta: "நிர்வாகக் குழு" },
