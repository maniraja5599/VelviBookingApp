...
export const BottomNav: React.FC = () => {
  ...
  const navItems = [
    ...
    { href: "/app/poojas", label: t("pooja"), icon: Flame },
    { href: "/app/more", label: t("more"), icon: Menu },
  ];

  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-velvi-creamLight border-t border-velvi-gold/30 shadow-[0_-4px_20px_rgba(0,0,0,0.04)] px-2 py-1.5 max-w-md mx-auto">
